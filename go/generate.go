...
//go:generate protoc --proto_path ../protobuf --go_out=build/protoc --twirp_out=build/protoc ../protobuf/model.proto
//go:generate rm -rf rpc
//go:generate cp -r build/protoc/github.com/ngyewch/twirp-playground/rpc .
//go:generate cp -r build/protoc/github.com/ngyewch/twirp-playground/rpc2 .
//go:generate rm -rf build/protoc
